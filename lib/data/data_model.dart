class Service{
  ...
  Service(this.id, this.libelle, this.description, this.qualiteDeService,
      this.qualiteDeServiceId, this.lastUpdate);

  Service.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
    libelle = json['attributes']['libelle'];
    description = json['attributes']['description'];
    qualiteDeService = json['attributes']['qualite_de_service']['data']
        ['attributes']['libelle'];
